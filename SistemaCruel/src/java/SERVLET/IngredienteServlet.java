 ...
 * @author Gustavo
 */
@WebServlet(name = "IngredienteServlet", urlPatterns = {"/IngredienteServlet"})
public class IngredienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String paginaParaEncaminharAExc = "";
            ...
            switch(action)
            {    
                case "formNovoIngrediente":

                break;
                case "formEditarIngrediente":

                break;
                case "excluirIngrediente":

                break;
                case "editarIngrediente":                       

                break;
                case "novoIngrediente":                       

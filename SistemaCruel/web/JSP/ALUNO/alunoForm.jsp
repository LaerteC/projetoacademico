         ...
         <nav class="navbar container" style="background-color: #054F77;">
            ...
            <form action="${pageContext.request.contextPath}/${redirecionarFormulario}" method="Post">
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="nome"
                      autocomplete="off"
                      value="<c:out value="${aluno.nome}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      autocomplete="off"
                      onkeyup="mascaraCPF()"
                      value="<c:out value="${aluno.cpf}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="email"
                      autocomplete="off"
                      value="<c:out value="${aluno.email}"/>" required="true">
                </div>
                <div class="form-group">
                   ...
                   <input 
                       ...
                       id="rua"
                       autocomplete="off"
                       value="<c:out value="${aluno.rua}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      onkeyup="mascaraCEP()"
                      autocomplete="off"
                      value="<c:out value="${aluno.cep}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <select
                    ...
                    <option ${empty aluno.nome ? 'selected' : ''}>Selecione um Estado</option>
                  </select>
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Cidade</label>
                    <select
                      ...
                      style="width:300px;"
                      >
                    <option ${empty aluno.idCidade ? 'selected' : ''}>Selecione uma Cidade</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      name="data"
                      id="data"
                      value="${aluno.dataNascimento}" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="curso"
                      autocomplete="off"
                      value="<c:out value="${aluno.curso}"/>" required="true">
                </div>
                <div class="form-group">
                   <label for="password">GRR</label>
                  <input 
                      type="text"
                      style="width:600px;"
                      maxlength="100"
                      ...
                      id="grr"
                      autocomplete="off"
                      value="<c:out value="${aluno.grr}"/>" required="true">
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Ano Ingresso</label>
                  <input 
                      type="date"
                      style="width:180px;"
                      class="form-control" 
                      name="anoIngresso"
                      id="anoIngresso"
                      value="${aluno.anoIngresso}" required="true">
                </div>
                <button 
                  style="background-color:${bloqueado.equals("verdadeiro") ? "#d3d3d3;" : "#027700;"}"
                  type="submit" 
                  class="btn btn-primary" 
                  id="cadastrar"
                >
                   ${(empty aluno.nome) ? "Salvar" : "Alterar" }
                </button>
                <a
            ...
            function mascaraCEP(){
             ...
             function getCidades(id){
                ...
                var selecionado = ${aluno.idCidade};
                ...
                $.ajax({
                        ...
                        success : function(data){
                            ...
                            $.each(data, function(i, obj) {
                                $("#cidade").append('<option' + (selecionado.equals(obj.idCidade) ? 'Selected' :'')  + 'value=' + obj.idCidade + ' >' + obj.nomeCidade + '</option>');
                            });
                        }
                    });
            ...
            if(${bloqueado.equals("verdadeiro")}){
              ...
              $('#grr').attr("disabled", true);
              $('#anoIngresso').attr("disabled", true);
            }

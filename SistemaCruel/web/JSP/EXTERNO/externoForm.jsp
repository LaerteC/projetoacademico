        ...
        <c:if test="${empty sessionScope.usuario}">
         ...
         <nav class="navbar container" style="background-color: #054F77;">
            ...
            <form action="${pageContext.request.contextPath}/${redirecionarFormulario}" method="Post">
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="nome"
                      autocomplete="off"
                      value="<c:out value="${externo.nome}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      autocomplete="off"
                      onkeyup="mascaraCPF()"
                      value="<c:out value="${externo.cpf}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="email"
                      autocomplete="off"
                      value="<c:out value="${externo.email}"/>" required="true">
                </div>
                <div class="form-group">
                   ...
                   <input 
                       ...
                       id="rua"
                       autocomplete="off"
                       value="<c:out value="${externo.rua}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      onkeyup="mascaraCEP()"
                      autocomplete="off"
                      value="<c:out value="${externo.cep}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <select
                    ...
                    <option ${empty externo.nome ? 'selected' : ''}>Selecione um Estado</option>
                  </select>
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Cidade</label>
                    <select
                      ...
                      style="width:300px;"
                      >
                    <option ${empty externo.idCidade ? 'selected' : ''}>Selecione uma Cidade</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      name="data"
                      id="data"
                      value="${externo.dataNascimento}" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="observacao"
                      autocomplete="off"
                      value="<c:out value="${externo.observacao}"/>" required="true">
                </div>
                <button 
                  ...
                  id="cadastrar"
                >
                   ${(empty externo.nome) ? "Salvar" : "Alterar" }
                </button>
                <a
            ...
            function getCidades(id){
                ...
                var selecionado = ${externo.idCidade};

        ...
        <c:if test="${empty sessionScope.usuario}">
         ...
         <nav class="navbar container" style="background-color: #054F77;">
            ...
            <form action="${pageContext.request.contextPath}/${redirecionarFormulario}" method="Post">
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="nome"
                      autocomplete="off"
                      value="<c:out value="${servidor.nome}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      autocomplete="off"
                      onkeyup="mascaraCPF()"
                      value="<c:out value="${servidor.cpf}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="email"
                      autocomplete="off"
                      value="<c:out value="${servidor.email}"/>" required="true">
                </div>
                <div class="form-group">
                   ...
                   <input 
                       ...
                       id="rua"
                       autocomplete="off"
                       value="<c:out value="${servidor.rua}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      onkeyup="mascaraCEP()"
                      autocomplete="off"
                      value="<c:out value="${servidor.cep}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <select
                    ...
                    <option ${empty servidor.nome ? 'selected' : ''}>Selecione um Estado</option>
                  </select>
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Cidade</label>
                    <select
                      ...
                      style="width:300px;"
                      >
                    <option ${empty servidor.idCidade ? 'selected' : ''}>Selecione uma Cidade</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      name="data"
                      id="data"
                      value="${servidor.dataNascimento}" required="true">
                </div>
                <div class="form-group">
                   <label for="password">Unidade</label>
                  <input 
                      type="text"
                      style="width:600px;"
                      maxlength="100"
                      ...
                      id="unidade"
                      autocomplete="off"
                      value="<c:out value="${servidor.unidade}"/>" required="true">
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Data Ingresso</label>
                  <input 
                      type="date"
                      style="width:180px;"
                      class="form-control" 
                      name="dataIngresso"
                      id="dataIngresso"
                      value="${servidor.dataIngresso}" required="true">
                </div>
                <button 
                  ...
                  id="cadastrar"
                >
                   ${(empty servidor.nome) ? "Salvar" : "Alterar" }
                </button>
                <a
            ...
            function getCidades(id){
                ...
                var selecionado = ${servidor.idCidade};

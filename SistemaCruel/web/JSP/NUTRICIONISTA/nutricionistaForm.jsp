    ...
    <body class="container" style="background-color:#F5F5DC;">
        ...
        <c:if test="${empty sessionScope.usuario}">
         ...
         <nav class="navbar container" style="background-color: #054F77;">
            ...
            <form action="${pageContext.request.contextPath}/${redirecionarFormulario}" method="Post">
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="nome"
                      autocomplete="off"
                      value="<c:out value="${nutricionista.nome}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      autocomplete="off"
                      onkeyup="mascaraCPF()"
                      value="<c:out value="${nutricionista.cpf}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="email"
                      autocomplete="off"
                      value="<c:out value="${nutricionista.email}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="senha"
                      autocomplete="off"
                      value="<c:out value="${nutricionista.senha}"/>" required="true">
                </div>
                <div class="form-group">
                   ...
                   <input 
                       ...
                       id="rua"
                       autocomplete="off"
                       value="<c:out value="${nutricionista.rua}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      onkeyup="mascaraCEP()"
                      autocomplete="off"
                      value="<c:out value="${nutricionista.cep}"/>" required="true">
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Crn</label>
                  <input 
                      type="text"
                      style="width:300px;"
                      maxlength="8"
                      ...
                      onkeyup="mascaraCRN()"
                      autocomplete="off"
                      value="<c:out value="${nutricionista.crm}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <select
                    ...
                    <option ${empty nutricionista.nome ? 'selected' : ''}>Selecione um Estado</option>
                  </select>
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Cidade</label>
                    <select
                      ...
                      style="width:300px;"
                      >
                    <option ${empty nutricionista.idCidade ? 'selected' : ''}>Selecione uma Cidade</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      name="data"
                      id="data"
                      value="${nutricionista.dataNascimento}" required="true">
                </div>
                <button 
                  ...
                  id="cadastrar"
                >
                   ${empty nutricionista.nome ? "Salvar" : "Alterar" }
                </button>
                <a
            ...
            if(!(${nutricionista.idCidade} === null)){
               getCidades(0); 
            }
            ...
            function mascaraCRN(){
                ...
                if(crn.value.length == 0){
                    crn.value += "CRN";
                }else if (crn.value.length == 6){
                    crn.value += "-";
                }
            }
            ...
            function getCidades(id){
                ...
                var selecionado = ${nutricionista.idCidade};

        ...
        <c:if test="${empty sessionScope.usuario}">
         ...
         <nav class="navbar container" style="background-color: #054F77;">
            ...
            <form action="${pageContext.request.contextPath}/${redirecionarFormulario}" method="Post">
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="nome"
                      autocomplete="off"
                      value="<c:out value="${atendente.nome}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      autocomplete="off"
                      onkeyup="mascaraCPF()"
                      value="<c:out value="${atendente.cpf}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="email"
                      autocomplete="off"
                      value="<c:out value="${atendente.email}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      id="senha"
                      autocomplete="off"
                      value="<c:out value="${atendente.senha}"/>" required="true">
                </div>
                <div class="form-group">
                   ...
                   <input 
                       ...
                       id="rua"
                       autocomplete="off"
                       value="<c:out value="${atendente.rua}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      onkeyup="mascaraCEP()"
                      autocomplete="off"
                      value="<c:out value="${atendente.cep}"/>" required="true">
                </div>
                <div class="form-group">
                  ...
                  <select
                    ...
                    <option ${empty atendente.nome ? 'selected' : ''}>Selecione um Estado</option>
                  </select>
                </div>
                <div class="form-group">
                   <label for="exampleInputEmail1">Cidade</label>
                    <select
                      ...
                      style="width:300px;"
                      >
                    <option ${empty atendente.idCidade ? 'selected' : ''}>Selecione uma Cidade</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input 
                      ...
                      name="data"
                      id="data"
                      value="${atendente.dataNascimento}" required="true">
                </div>
                <button 
                  ...
                  id="cadastrar"
                >
                   ${(empty atendente.nome) ? "Salvar" : "Alterar" }
                </button>
                <a
            ...
            function getCidades(id){
                ...
                var selecionado = ${atendente.idCidade};
